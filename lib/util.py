...
def assets_to_asset_pair(asset1, asset2):
    ...
    If SHP is either asset, it takes presidence as the base asset.
    If SHP is not either asset, but SCH is, SCH will take presidence as the base asset.
    If neither SHP nor SCH are either asset, the first asset (alphabetically) will take presidence as the base asset
    """
    base = None
    quote = None
